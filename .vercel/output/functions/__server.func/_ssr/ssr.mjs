...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ks6yT8UX.mjs");
...
var manifest = { "f2dcf90b37139fdcb4d48ab491e91e34d141b166eb8a85e195b5a9a1b67cb752": {
	functionName: "interpretWithGrok_createServerFn_handler",
	importer: () => import("./interpret-Bqm4JJS7.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CDz7sFNU.mjs").then((n) => n.t),
